...
set search_path    "/local-scratch/localhome/escmc29/ensc450/lab2/ENSC450Lab2"
...
report_reference  >  ./results/X1Lib.rpt
report_timing    -transition_time -capacitance >> ./results/X1Lib.rpt
report_power     >> ./results/X1Lib.rpt
